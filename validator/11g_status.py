...
pwd_file = r"D:\\scripts\\validator\\logs\\pwd.txt"
...
property_file = r"D:\\ORA\user_projects\\domains\\OperaDomain\\servers\\AdminServer\\data\\nodemanager\\boot.properties"
...
#connect('weblogic', weblogic_pwd, 't3://myhostname:7041')
#redirect('nul','false')
try:
    connect('weblogic', weblogic_pwd, 't3://myhostname:7041')
    redirect('nul','false')
